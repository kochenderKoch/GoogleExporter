// ignore_for_file: constant_identifier_names, use_setters_to_change_properties,
...
extension _EnvProperties on AppEnvironment {
  static const _appTitles = {
    AppEnvironment.DEV: 'Google Exporter Dev',
    AppEnvironment.STAGING: 'Google Exporter Staging',
    AppEnvironment.PROD: 'Google Exporter',
  };

  static const _connectionStrings = {
    AppEnvironment.DEV: 'https://api.example.com',
    AppEnvironment.STAGING: 'https://api.example.com',
